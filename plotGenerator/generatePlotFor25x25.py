...
# Read the data
df = pd.read_csv('updated_benchmark_results_25x25.csv')
...
plt.title('25x25 Matrix: Runtime Comparison', fontsize=16)
plt.legend(fontsize=12)
plt.grid(True, alpha=0.3)

plt.tight_layout()
plt.savefig('updated_25x25_benchmark.png', dpi=100, bbox_inches='tight')
plt.show()
