...
# Read the data
df = pd.read_csv('updated_benchmark_results_30x30.csv')
...
plt.title('30x30 Matrix: Runtime Comparison', fontsize=16)
plt.legend(fontsize=12)
plt.grid(True, alpha=0.3)

plt.tight_layout()
plt.savefig('updated_30x30_benchmark.png', dpi=100, bbox_inches='tight')
plt.show()