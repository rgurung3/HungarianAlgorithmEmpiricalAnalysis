...
# Read the data
df = pd.read_csv('updated_benchmark_results_10x10.csv')
...
plt.title('10x10 Matrix: Runtime Comparison', fontsize=16)
plt.legend(fontsize=12)
plt.grid(True, alpha=0.3)

plt.tight_layout()
plt.savefig('updated_10x10_benchmark.png', dpi=100, bbox_inches='tight')
plt.show()